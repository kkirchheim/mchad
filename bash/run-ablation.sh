...
python run.py -m experiment="cifar10-gmchad" model.weight_oe="range(0,1.1,0.1)" trainer.min_epochs=100 trainer.gpus=1 hydra.sweep.dir="${log_dir}/vary_oe" dataset_dir="/data_fast/kirchheim/datasets/" ${options}

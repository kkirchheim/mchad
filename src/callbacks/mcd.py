...
class MonteCarloDropout(pl.callbacks.Callback):
    ...
    def __init__(self, num_classes, rounds, use_in_val=False, use_in_test=True, **kwargs):
        self.rounds = rounds
    ...
    def _eval_epoch_end(self, pl_module, stage):
        ...
        log_osr_metrics(pl_module, confidence_mcd, stage, y, method=MonteCarloDropout.NAME)
        log_uncertainty_metrics(pl_module, confidence_mcd, stage, y, y_hat, method=MonteCarloDropout.NAME)
        log_error_detection_metrics(pl_module, confidence_mcd, stage, y, y_hat, method=MonteCarloDropout.NAME)
        log_score_histogram(pl_module, stage, confidence_mcd, y, y_hat, method=MonteCarloDropout.NAME)
